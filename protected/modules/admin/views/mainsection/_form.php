...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldGroup($model,'price',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>256)))); ?>
    ...
    <div class="form-group">
		<a href="/uploads/mainsections/<?php echo $model->img;?>" class="fancybox"><?php echo CHtml::image('/uploads/mainsections/'.$model->img, "Изображение", array('style'=>'width:200px')); ?></a>
	</div>
	<?php endif; ?>
