...
public function saveImages($model)
{
	if (CUploadedFile::getInstance($model, 'img'))
	{
        ...
        $upload_directory = Yii::getPathOfAlias('webroot') . '/uploads/items/';
		...
		$image->resize(246, 149, ImageConv::HEIGHT);

		$upload_directory2 = Yii::getPathOfAlias('webroot') . '/uploads/items/'.$image_name;
