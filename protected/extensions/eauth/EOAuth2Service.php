...
abstract class EOAuth2Service extends EAuthServiceBase implements IAuthService {
	...
	protected function getTokenUrl($code) {
		$url = $this->providerOptions['access_token'] . '?client_id=' . $this->client_id . '&client_secret=' . $this->client_secret . '&code=' . $code . '&redirect_uri=' . urlencode($this->getState('redirect_uri'));
		return $url;
	}
